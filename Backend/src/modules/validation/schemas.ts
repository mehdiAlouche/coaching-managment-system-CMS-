...
export const organizationCreateSchema = z.object({
  body: z.object({
    ...
    maxCoaches: z.number().min(0).optional(),
    maxEntrepreneurs: z.number().min(0).optional(),
    contact: z
      .object({
...
export const organizationUpdateSchema = z.object({
  body: z.object({
    ...
    billingEmail: emailSchema.optional(),
    subscriptionPlan: z.enum(['free', 'standard', 'premium']).optional(),
    subscriptionStatus: z.enum(['trialing', 'active', 'past_due', 'paused', 'canceled']).optional(),
    subscriptionRenewalAt: z.string().datetime().optional(),
    maxUsers: z.number().min(1).optional(),
    maxCoaches: z.number().min(0).optional(),
    maxEntrepreneurs: z.number().min(0).optional(),
    isActive: z.boolean().optional(),
...
export const organizationManagerSettingsSchema = z.object({
  body: z.object({
    notificationPreferences: z
      .object({
        emailOnNewSession: z.boolean().optional(),
        emailOnSessionCancel: z.boolean().optional(),
        emailOnGoalUpdate: z.boolean().optional(),
    ...
    dashboardLayout: z
      .object({
        defaultView: z.enum(['overview', 'sessions', 'members', 'revenue']).optional(),
        widgets: z.array(z.string()).optional(),
      })
      .optional(),
    approvalThresholds: z
      .object({
        sessionPricingApproval: z.boolean().optional(),
        coachOnboardingApproval: z.boolean().optional(),
      })
      .optional(),
  }),
});
