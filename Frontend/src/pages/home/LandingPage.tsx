    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A comprehensive coaching management system 
      ...
      <section className="container mx-auto px-4 py-20 bg-gradient-primary">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-foreground/90">
            Join incubators like Startup in streamlining their coaching
            operations
          </p>
          <Link to="/auth/login">
      ...
      <footer className="border-t border-border py-8">
        <div className="container mx-auto px-4 text-center text-muted-foreground">
          <p>
            © 2025 CMS. Built with React, TypeScript, and Tailwind
            CSS.
          </p>
        </div>
      </footer>
