...
const endpoints = {
  ...
  auth: {
    ...
    forgotPassword: import.meta.env.VITE_API_ENDPOINT_AUTH_FORGOT_PASSWORD || '/auth/forgot-password',
    verifyResetToken: import.meta.env.VITE_API_ENDPOINT_AUTH_VERIFY_RESET_TOKEN || '/auth/verify-reset-token',
    resetPassword: import.meta.env.VITE_API_ENDPOINT_AUTH_RESET_PASSWORD || '/auth/reset-password',
  },
  ...
  organization: {
    ...
    stats: import.meta.env.VITE_API_ENDPOINT_ORGANIZATION_STATS || '/organization/stats',
    updateManagerSettings: import.meta.env.VITE_API_ENDPOINT_ORGANIZATION_MANAGER_SETTINGS || '/organization/settings/manager',
  ...
  // ─────────────────────────────────────────
  organizationAdmin: {
    create: import.meta.env.VITE_API_ENDPOINT_ORG_ADMIN_CREATE || '/organization/admin/create',
    list: import.meta.env.VITE_API_ENDPOINT_ORG_ADMIN_LIST || '/organization/admin/list',
    get: (organizationId: string) => {
      const template = import.meta.env.VITE_API_ENDPOINT_ORG_ADMIN_GET || '/organization/admin/:organizationId'
      return replaceParams(template, { organizationId })
    },
    update: (organizationId: string) => {
      const template = import.meta.env.VITE_API_ENDPOINT_ORG_ADMIN_UPDATE || '/organization/admin/:organizationId'
      return replaceParams(template, { organizationId })
    },
    delete: (organizationId: string) => {
      const template = import.meta.env.VITE_API_ENDPOINT_ORG_ADMIN_DELETE || '/organization/admin/:organizationId'
      return replaceParams(template, { organizationId })
    },
  },
  ...
  // ─────────────────────────────────────────
  admin: {
    activity: import.meta.env.VITE_API_ENDPOINT_ADMIN_ACTIVITY || '/admin/activity',
    activityStats: import.meta.env.VITE_API_ENDPOINT_ADMIN_ACTIVITY_STATS || '/admin/activity/stats',
  },
